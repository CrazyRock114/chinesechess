...
import {
  ...
  toFEN, loadFEN,
} from './game.js?v=cb26dc068c';
import { LANG_HANT, LANG_HANS, I18N } from './i18n.js?v=cb26dc068c';
import {
  generateCommentary,
  getGuidance,
  speakCommentary,
  ...
  cancelSpeech,
  isSpeaking,
} from './commentary.js?v=cb26dc068c';
...
try {
  aiWorker = new Worker(new URL('./ai-worker.js?v=cb26dc068c', import.meta.url), { type: 'module' });
...
function requestAIMove() {
  ...
  if (aiWorker) {
    ...
    (aiModule ??= import('./ai.js?v=cb26dc068c')).then(({ findBestMove }) => {
      setTimeout(() => {
